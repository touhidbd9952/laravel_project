...
<section class="breadcrumbs-custom bg-image" style="background-image: url({{$base_url}}/fontend/images/bg-image-6.jpg);">
    <div class="shell">
      <h2 class="breadcrumbs-custom__title">コンタクト</h2>
      <ul class="breadcrumbs-custom__path">
        <li><a href="{{url('/')}}">ホーム</a></li>
        <li class="active">コンタクト</li>
      </ul>
    </div>
  </section>
      ...
      <div class="layout-bordered">
        <div class="layout-bordered__main text-center">
          <div class="layout-bordered__main-inner">
            <h3>連絡する</h3>
            <p>ファックス、電子メール、または電話で24時間年中無休でご利用いただけます。 また、クイックコンタクトフォームを使用して、当社のサービスやプロジェクトについて質問することもできます</p>
            <!-- RD Mailform-->
          ...
          <div class="layout-bordered__aside-item">
            ...
            <div class="unit unit-horizontal unit-spacing-xxs">
              ...
              <div class="unit__body">
                ...
                <a href="#">成田工場：185-943戸倉 <br> 千葉県富里市286-0212</a>
              </div>
            </div>
          </div>
        </div>
