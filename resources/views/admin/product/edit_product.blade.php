                        ...
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Fabricator Product Edit Form</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('product/update/' . $products->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="old_img" value="{{$products->thumbnail_image}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="cat_id" id="categoryList" autocomplete="off" class="form-control @error('cat_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{$cat->id}}" {{$cat->id == $products->cat_id ? 'selected':''}}>{{ $cat->title }}</option>
                                    @endforeach
                                </select>
                                @error('cat_id')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text"  name="title" value="{{$products->title}}" autocomplete="off" class="form-control @error('title') is-invalid @enderror"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text"  name="title_jp" value="{{$products->title_jp}}" autocomplete="off" class="form-control @error('title_jp') is-invalid @enderror"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea  name="short_des"  autocomplete="off" class="form-control @error('short_des') is-invalid @enderror"
                                    placeholder="Product Short Description">{{$products->short_des}}</textarea>
                                @error('short_des')
                                    <span class="text-danger"> {{$message}}  </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea  name="short_des_jp"  autocomplete="off" class="form-control @error('short_des_jp') is-invalid @enderror"
                                    placeholder="Product Short Description In Japanese">{{$products->short_des_jp}}</textarea>
                                @error('short_des_jp')
                                    <span class="text-danger"> {{$message}}  </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea  name="detail_des" autocomplete="off" class="form-control @error('detail_des') is-invalid @enderror"
                                    placeholder="Product Details Description" style="min-height: 120px">{{$products->detail_des}}</textarea>
                                @error('short_des')
                                    <span class="text-danger"> {{$message}}  </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea  name="detail_des_jp" autocomplete="off" class="form-control @error('detail_des_jp') is-invalid @enderror"
                                    placeholder="Product Details Description In Japanese" style="min-height: 120px">{{$products->detail_des_jp}}</textarea>
                                @error('detail_des_jp')
                                    <span class="text-danger"> {{$message}}  </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                onchange="loadFile(event)">
                                    <img src="{{asset($products->thumbnail_image)}}" id="output" style="width: 300px;height:auto;margin-top:10px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="publish_status" class="form-control @error('publish_status') is-invalid @enderror">
                                    <option value="publish" {{$products->publish_status == 'publish'?'selected':''}}>Publish</option>
                                    <option value="unpublish" {{$products->publish_status == 'unpublish'?'selected':''}}>Unpublish</option>
                                </select>
