...
class MainController extends Controller
{
    ...
    public function index()
    {
        ...
        $categories = Category::with('user')->where('publish_status','publish')->orderby('sl','asc')->get();
    ...
    //all category show 
    public function amphibious_items()
    { 
    ...
    public function amphibious_view($id)
    {
        //page selection
    ...
    {   
        ...
        //by which mailable class
            ...
            Mail::to('info@woodyltd.com')->send(new customerMailContact($data));
